        ...
        <div class="table-main-container">
            <div class="table-box">
                ...
                <div class="table">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input type="text" class="form-input readonly" value="HDB Project" readonly>
                        </div>
                        <div class="col-6">
                            <input type="text" class="form-input readonly" id="project-value" value="<?= $_GET['project'] ?? 'N/A'; ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-input readonly" id="block-value" value="<?= $_GET['block'] ?? 'N/A'; ?>" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <input type="text" class="form-input readonly" id="unit-value" value="<?= $_GET['unit'] ?? 'N/A'; ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
